...
Preserve user work. Keep generated files, caches, dependency directories, and build output out of version control. Commit the npm lockfile. Update generated distribution notices when adding runtime dependencies; verify all three license files are included in dist/. Do not initialize Git, publish, or deploy unless requested. Use the project's MIT license and retain dependency notices. Leave no machine-specific paths in source or docs.
